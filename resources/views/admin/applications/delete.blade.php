...
@section('title', 'RMS v1.0 | Confirm Delete')

@section('content_header')
    <div class="row mb-2">
        <div class="col-sm-6">
            <h1 class="m-0">Delete Application</h1>
        </div>
        <div class="col-sm-6">
        ...
        <div class="row">
            <div class="col-lg-6 col-md-12">
                <div class="card">
                    ...
                    <form method="post" action="{{route('admin.applications.destroy', ['application' => $application])}}">
                        @csrf 
                        @method('delete')
                        <div class="card-body">
                        ...
                        <div class="card-footer">
                            ...
                            <a href="{{route('admin.applications.show', ['application' => $application])}}" class="btn btn-default float-right">No</a>
                        </div>
                    </form> 
                </div>
            </div>
